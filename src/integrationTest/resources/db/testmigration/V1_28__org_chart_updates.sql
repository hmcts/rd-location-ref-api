update jurisdiction set description = 'Employment Tribunals', last_update = timezone('utc', now())
where jurisdiction_id = (select jurisdiction_id from jurisdiction where description = 'Employment Tribunerals');

insert into jurisdiction (jurisdiction_id, description, last_update)
values
    (11, 'Upper Tribunal Tax and Chancery Chamber', timezone('utc', now())),
    (12, 'Upper Tribunal Lands Chamber', timezone('utc', now())),
    (13, 'Upper Tribunal Administrative Appeals Chamber', timezone('utc', now())),
    (14, 'Upper Tribunal Immigration and Asylum Chamber', timezone('utc', now())),
    (15, 'Employment Appeals', timezone('utc', now()));

delete from service where service_code = 'BAA1' and service_description = 'Alternative Business Structures';

delete from service where service_code = 'BAA3' and service_description = 'Claims Management Services';

delete from service where service_code = 'BAA4' and service_description = 'Consumer Credit';

update service set service_description = 'Gambling', last_update = timezone('utc', now())
where service_code = 'BAA8' and service_description = 'Gambling Appeals';

delete from service where service_code = 'BAB2' and service_description = 'Local Government Standards';

insert into service (service_id, org_unit_id, business_area_id, sub_business_area_id, jurisdiction_id, service_code,
  service_description, service_short_description, last_update) values (
  46,
  (select org_unit_id from org_unit where description='HMCTS'),
  (select business_area_id from org_business_area where description ='Civil, Family and Tribunals'),
  (select sub_business_area_id from org_sub_business_area   where description ='Tribunals'),
  (select jurisdiction_id from jurisdiction where description ='General Regulatory Chamber'),
  'BAB4',
...
insert into service (service_id, org_unit_id, business_area_id, sub_business_area_id, jurisdiction_id, service_code,
  ...
  (select business_area_id from org_business_area where description ='Civil, Family and Tribunals'),
  (select sub_business_area_id from org_sub_business_area   where description ='Tribunals'),
  (select jurisdiction_id from jurisdiction where description ='Upper Tribunal Tax and Chancery Chamber'),
  'BTA1',
...
insert into service (service_id, org_unit_id, business_area_id, sub_business_area_id, jurisdiction_id, service_code,
  ...
  (select business_area_id from org_business_area where description ='Civil, Family and Tribunals'),
  (select sub_business_area_id from org_sub_business_area   where description ='Tribunals'),
  (select jurisdiction_id from jurisdiction where description ='Upper Tribunal Lands Chamber'),
  'BLA1',
...
insert into service (service_id, org_unit_id, business_area_id, sub_business_area_id, jurisdiction_id, service_code,
  ...
  (select business_area_id from org_business_area where description ='Civil, Family and Tribunals'),
  (select sub_business_area_id from org_sub_business_area   where description ='Tribunals'),
  (select jurisdiction_id from jurisdiction where description ='Upper Tribunal Immigration and Asylum Chamber'),
  'BIA1',
...
insert into service (service_id, org_unit_id, business_area_id, sub_business_area_id, jurisdiction_id, service_code,
  ...
  (select business_area_id from org_business_area where description ='Civil, Family and Tribunals'),
  (select sub_business_area_id from org_sub_business_area   where description ='Tribunals'),
  (select jurisdiction_id from jurisdiction where description ='Upper Tribunal Administrative Appeals Chamber'),
  'BKA4',
...
insert into service (service_id, org_unit_id, business_area_id, sub_business_area_id, jurisdiction_id, service_code,
  ...
  (select business_area_id from org_business_area where description ='Civil, Family and Tribunals'),
  (select sub_business_area_id from org_sub_business_area   where description ='Tribunals'),
  (select jurisdiction_id from jurisdiction where description ='Employment Appeals'),
  'BMA1',
